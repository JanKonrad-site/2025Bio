const sections = ['section1',
                  'section1-1', 'section1-2','section1-3', 'section1-4', 'section1-5', 'section1-6','section1-7','section1-8',
                  'section2',
                  'section2-1',
                  ...
                  'section4','section4-1-1','section4-1-2', 'section4-1-2a','section4-1-3','section4-1-4','section4-1-5','section4-1-6','section4-1-7','section4-1-8','section4-1-9','section4-1-10',
                  'section4-3-1','section4-3-2','section4-3-3','section4-3-4',

                  'section3-1-1', 'section3-1-2', 'section3-1-3','section3-1-4','section3-1-5', 'section3-1-6',
...
function setupIntersectionObserver() {
  observer = new IntersectionObserver((entries) => {
    ...
    root: null,
    rootMargin: '0px',
    threshold: 0.2 // upravit podle výšky sekcí
  });
